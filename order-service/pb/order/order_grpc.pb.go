...
type OrderServiceClient interface {
	...
	GetOrdersByCustomer(ctx context.Context, in *GetOrdersByCustomerRequest, opts ...grpc.CallOption) (*OrderListResponse, error)
}
...
func (c *orderServiceClient) GetOrdersByCustomer(ctx context.Context, in *GetOrdersByCustomerRequest, opts ...grpc.CallOption) (*OrderListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type OrderServiceServer interface {
	...
	GetOrdersByCustomer(context.Context, *GetOrdersByCustomerRequest) (*OrderListResponse, error)
...
func (UnimplementedOrderServiceServer) GetOrdersByCustomer(context.Context, *GetOrdersByCustomerRequest) (*OrderListResponse, error) {
